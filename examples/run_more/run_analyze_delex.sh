...
echo "======================"
echo "Running with lang = $1_$2_$3 (de-lexicalized!)"
...
--punctuation 'PUNCT' 'SYM' --out_filename analyzer.$cur_lang.$which_set.delex.out --model_name 'network.pt' \
--test "../data2.2_more/${cur_lang}_${which_set}.conllu" --model_path "./model/"
...
# RGPU=0 bash ../src/examples/run_more/run_analyze_delex.sh test biaffine |& tee log_test_delex
# see the results?
